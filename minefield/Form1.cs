        ...
        private void diffLvl (object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 13; i++)
            {
                for (int x = 0; x < 13; x++)
                {
                    ...
                    uknBtn.Click +=new EventHandler(clickUnkBtn);
                }
            }
            easyForm.Show();
        }

        private void clickUnkBtn(object sender, EventArgs e)
        {
            Console.WriteLine("hii");
            //Button clickedUnkBtn = (Button)sender;
            //clickedUnkBtn.Enabled = false;
            Console.WriteLine(mineLoc[0, 0]);
